...
import { Form, Button, Navbar, Nav, Modal} from 'react-bootstrap/';
...
const AppMovies = () => {
    ...
    const [movies, setMovies] = useState([
            ...
            imgSrc:'300.jpg'},
        {
            ...
            description: "In the film, Callum Lynch explores the memories of his ancestor Aguilar de Nerha and gains the skills of a Master Assassin, before taking on the secret Templar society.",
            url: "123456",
            note: 'lorem',
